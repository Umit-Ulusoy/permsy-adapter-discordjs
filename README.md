Haklısın kanka, "official" ifadesi sanki Discord.js ekibi kendisi yayınlamış gibi yanlış anlaşılabilir. Onu Permsy'nin resmi Discord.js adaptörü anlamında "Official Discord.js adapter for Permsy" şeklinde düzeltmek çok daha doğru olur.

İşte hiç Markdown formatı kullanmadan, tamamen düz metin şeklinde README içeriği:
